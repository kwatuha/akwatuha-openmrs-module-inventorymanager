...
public class MohTBStartDateRule extends MohEvaluableRule {

	private static final Log log = LogFactory.getLog(MohTBStartDateRule.class);
	...
	public Result evaluate(final LogicContext context, final Integer patientId, final Map<String, Object> parameters) throws LogicException {
		...
		Concept TBStartDate=Context.getConceptService().getConcept(MohEvaluableNameConstants.START_DRUGS);
